...
const ProductDetails = () => {
  ...
  useEffect(() => {
    let singleProduct = allProducts.find(
      (prod) => prod.id.toString() === productId.id
    );
  ...
  return (
    <div className="mx-auto px-4 w-full max-w-7xl bg-white text-gray-700 col-span-8">
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="lg:py-8 w-full lg:w-1/2 flex flex-col lg:border-l-2 border-gray-200">
          ...
          <div className="order-2 lg:order-3 pt-8 sm:px-6 flex flex-wrap lg:flex-nowrap justify-around items-center border-b-2 lg:border-none border-gray-200">
            ...
            <button
              type="button"
              className="m-2.5 py-1.5 px-5 inline-flex items-center rounded-md bg-sky-600 text-base text-white font-semibold uppercase whitespace-nowrap hover:bg-sky-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
      ...
      <button
        type="button"
        className="mt-5 py-1.5 px-10 inline-flex items-center rounded-md bg-sky-600 text-base text-white font-semibold uppercase whitespace-nowrap hover:bg-sky-500"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
